...
You will be asked to do the following:
  ...
  * use **cvLASSO** function to select the tuning parameter, see how $CV(\lambda)$ changes with lambda (you should expect to see a lot of variability from one fold split to another)
